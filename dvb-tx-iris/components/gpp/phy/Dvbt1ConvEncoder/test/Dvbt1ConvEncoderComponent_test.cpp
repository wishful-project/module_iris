/**
 * \file components/gpp/phy/Dvbt1ConvEncoder/test/Dvbt1ConvEncoderComponent_test.cpp
 * \version 1.0
 *
 * \section COPYRIGHT
 *
 ...
 * \section DESCRIPTION
 *
 * Main test file for Dvbt1ConvEncoder component.
 */

#define BOOST_TEST_MODULE Dvbt1ConvEncoderComponent_test
...
BOOST_AUTO_TEST_SUITE (Dvbt1ConvEncoderComponent_Test)

BOOST_AUTO_TEST_CASE(Dvbt1ConvEncoderComponent_Basic_Test)
{
  BOOST_REQUIRE_NO_THROW(Dvbt1ConvEncoderComponent mod("test"));
}

BOOST_AUTO_TEST_CASE(Dvbt1ConvEncoderComponent_Parm_Test)
{
  Dvbt1ConvEncoderComponent mod("test");
  BOOST_CHECK(mod.getParameterDefaultValue("debug") == "false");
}

BOOST_AUTO_TEST_CASE(Dvbt1ConvEncoderComponent_Ports_Test)
{
  Dvbt1ConvEncoderComponent mod("test");
...
BOOST_AUTO_TEST_CASE(Dvbt1ConvEncoderComponent_Init_Test)
{
  Dvbt1ConvEncoderComponent mod("test");
  mod.registerPorts();
...
BOOST_AUTO_TEST_CASE(Dvbt1ConvEncoderComponent_Process_Test)
{
  ...
  if(true)
  {
    ...
    BOOST_CHECK(oSet->data.size() == num * 8 * 2); // good size
