/**
 * \file components/gpp/phy/Dvbt1ConvInterleaver/test/Dvbt1ConvInterleaverComponent_test.cpp
 * \version 1.0
 *
 * \section COPYRIGHT
 *
...
#define BOOST_TEST_MODULE Dvbt1ConvInterleaverComponent_test
...
BOOST_AUTO_TEST_SUITE (Dvbt1ConvInterleaverComponent_Test)

BOOST_AUTO_TEST_CASE(Dvbt1ConvEncoderComponent_Basic_Test)
{
  BOOST_REQUIRE_NO_THROW(Dvbt1ConvInterleaverComponent mod("test"));
}

BOOST_AUTO_TEST_CASE(Dvbt1ConvInterleaverComponent_Parm_Test)
{
  Dvbt1ConvInterleaverComponent mod("test");
  BOOST_CHECK(mod.getParameterDefaultValue("debug") == "false");
}

BOOST_AUTO_TEST_CASE(Dvbt1ConvInterleaverComponent_Ports_Test)
{
  Dvbt1ConvInterleaverComponent mod("test");
...
BOOST_AUTO_TEST_CASE(Dvbt1ConvInterleaverComponent_Init_Test)
{
  Dvbt1ConvInterleaverComponent mod("test");
  mod.registerPorts();
...
BOOST_AUTO_TEST_CASE(Dvbt1ConvInterleaverComponent_Process_Test)
{
